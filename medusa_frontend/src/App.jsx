...
function App() {
  ...
  const { product, isLoading: isLoadingProduct } = useProduct("prod_01HWAJFCMSJCC3NRTCFY2KYDXH")
  ...
  return (
    <>
      ...
      <div className={style.card}>
        ...
        <p>Price: {formatVariantPrice({ variant: product.variants[0], region: regions[3] })}</p>
